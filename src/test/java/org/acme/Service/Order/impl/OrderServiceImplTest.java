...
class OrderServiceImplTest {
    ...
    void register_shouldPersistOrder_andDecrementStockForEachLine() {
        ...
        verify(articleService, times(1)).decrementQuantity(coffee.id(), BigDecimal.valueOf(2));
        verify(articleService, times(1)).decrementQuantity(tea.id(), BigDecimal.valueOf(1));
    ...
    void register_shouldPropagateNotFound_whenAnArticleDoesNotExist() {
        ...
        verify(articleService, org.mockito.Mockito.never()).decrementQuantity(anyString(), any(BigDecimal.class));
    }
    ...
    void register_shouldNotRecordAlert_whenSoldAtOrAboveCostPrice() {
        ...
        verify(alertService, never()).recordNegativeMarginSale(
                anyString(), anyString(), anyString(), anyString(), any(), any(), any(), any(BigDecimal.class)
        );
    }
}
