...
class ClientServiceImplTest {
    ...
    void getAll_sumsOrdersCaAndCountPerClient() {
        ...
        order1.setArticles(new java.util.ArrayList<>(
            List.of(new org.acme.Entity.OrderItem(null, "Savon noir", java.math.BigDecimal.valueOf(1200), java.math.BigDecimal.valueOf(2)))
        ));
        Order order2 = new Order();
        order2.setClientId(clientId);
        order2.setArticles(new java.util.ArrayList<>(
            List.of(new org.acme.Entity.OrderItem(null, "Crème hydratante", java.math.BigDecimal.valueOf(2500), java.math.BigDecimal.valueOf(1)))
        ));
