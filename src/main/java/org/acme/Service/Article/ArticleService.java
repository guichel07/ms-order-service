...
public interface ArticleService {
    ...
    ArticleResponseDTO decrementQuantity(String id, int quantityOrdered);
    ArticleResponseDTO incrementQuantity(String id, int quantityAdded);
     ...
     */
    ArticleResponseDTO receiveStock(String id, int qty, BigDecimal purchasePrice, BigDecimal transportShare);
}
